...
<!-- Mirrored from newflightd.com/?page_id=15 by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 28 May 2016 17:37:31 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1, user-scalabe=no">
<title>Tracking | Elmer Global Services</title>
...
<link rel='prev' title='Same Day Delivery' href='index787c.html?page_id=11' />
<link rel='next' title='International Delivery' href='index8db2.html?page_id=17' />
<meta name="generator" content="WordPress 3.9.6" />
<link rel='canonical' href='indexc185.html?page_id=15' />
...
<body class="page page-id-15 page-template-default custom-background right-sidebar">
    ...
    <div id="top-header">
		<div class="ak-container">
			<div class="site-branding">
					...
					<img src="wp-content/uploads/2013/11/cropped-logo.png" alt="New Flight">
				</a>
...
<li id="menu-item-40" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-15 current_page_item menu-item-40"><a href="indexc185.html?page_id=15">Tracking</a></li>
...
<article id="post-15" class="post-15 page type-page status-publish hentry">
	...
	<div class="entry-content">
		<p>If you are expecting to receive a delivery from Elmer Global Services, then you can Track your Parcel below:<br />
Our tracking system will tell you the current status of your delivery and when you can expect your parcel to be delivered.</p>

 <p align="center" style="font-size: 30px; color: #FF0000; font-weight: bold"><?php if (array_key_exists('fail', $_GET)) { echo "Wrong Tracking Details";} else {echo " ";} ?></p>

<div style="margin-right: 20px; background: url('images/trackbg.gif')no-repeat; margin-left: 180px;">
<div style="width: auto; padding-top: 70px; height: 60px;">
<form action="tracklogin.php" method="POST"><input type="text" name="track_number" size="20" margin-left: 180px; required/><br />
<input type="submit" name="submit" value="Track" style="margin-left: 200px; margin-bottom: -20px;  margin-top: -30px; position: absolute;"/></form>
</div>
</div>
			</div><!-- .entry-content -->
	</article><!-- #post-## -->
	...
	<div id="secondary-right" class="widget-area right-sidebar sidebar">
	        ...
	        <h1 class="widget-title">Elmer Global Services</h1>

	        	        	<div class="event-list clearfix">
	        		
	        		<figure class="event-thumbnail">
						<a href="index85b0.html?p=233">
												<img src="wp-content/uploads/2014/07/aircargo02-135x100.jpg" alt="Air Freight">
					...
					<div class="event-detail">
		        		<h4 class="event-title">
		        			<a href="index85b0.html?p=233">Air Freight</a>
		        		</h4>

		        		<div class="event-excerpt">
		        			Elmer Global Servicesis equipped with the right expe... 
		        		</div>
	        		</div>
	        	</div>
	        	        	<div class="event-list clearfix">
	        		...
	        		<figure class="event-thumbnail">
						<a href="indexcff1.html?p=1">
												<img src="wp-content/uploads/2013/11/welcome-image-135x100.jpg" alt="Welcome to Elmer Global Services">
					...
					<div class="event-detail">
		        		<h4 class="event-title">
		        			<a href="indexcff1.html?p=1">Welcome to Elmer Global Services</a>
		        		</h4>

		        		<div class="event-excerpt">
		        			Elmer Global Servicesis one of Canada's leading premium expr... 
		        		</div>
	        		</div>
	        	</div>
	        	        	        <a class="all-events" href="indexb31a.html?cat=1">View All</a>
	        	        	        </aside>
	    		...
	    		<aside class="widget testimonail-sidebar clearfix">
			        ...
			        <div class="testimonail-list">
			        	<div class="testimonail-thumbnail">
			        		<img width="100" height="100" src="wp-content/uploads/2014/07/testimonial-image3.jpg" class="attachment-thumbnail wp-post-image" alt="testimonial-image3" />		        		</div>

			        	<div class="testimonail-excerpt">
			        		It is important to establish a good working relationship with any supplier. Elmer Global Services...			        	</div>
			        	<div class="clearfix"></div>
					<div class="testimoinal-client-name">Testimonial3</div>
					</div>
			
			        <div class="testimonail-list">
			        	<div class="testimonail-thumbnail">
			        		<img width="100" height="100" src="wp-content/uploads/2014/07/testimonial-image2.jpg" class="attachment-thumbnail wp-post-image" alt="testimonial-image2" />		        		</div>

			        	<div class="testimonail-excerpt">
			        		The whole procedure was effortless- from my side a pleasure. The driver was equally helpfu...			        	</div>
			        	<div class="clearfix"></div>
					<div class="testimoinal-client-name">Testimonial2</div>
					</div>
			
			        <div class="testimonail-list">
			        	<div class="testimonail-thumbnail">
			        		<img width="100" height="100" src="wp-content/uploads/2014/07/testimonial-image1.jpg" class="attachment-thumbnail wp-post-image" alt="testimonial-image1" />		        		</div>

			        	<div class="testimonail-excerpt">
			        		I popped in to collect a parcel last week and spoke to you briefly about giving some good ...			        	</div>
			        	<div class="clearfix"></div>
					<div class="testimoinal-client-name">Testimonial1</div>
					</div>
				        </div>
                        <a class="all-testimonial" href="index0b40.html?cat=9">View All</a>
...
<!-- Mirrored from newflightd.com/?page_id=15 by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 28 May 2016 17:37:32 GMT -->
</html>
