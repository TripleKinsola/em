...
<!-- Mirrored from newflightd.com/?page_id=28 by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 28 May 2016 17:37:32 GMT -->
...
<link rel='prev' title='Our Responsibility' href='index16e4.html?page_id=24' />
<link rel='next' title='My Account' href='index9747.html?page_id=119' />
<meta name="generator" content="WordPress 3.9.6" />
<link rel='canonical' href='indexc583.html?page_id=28' />
...
<body class="page page-id-28 page-template-default custom-background right-sidebar">
...
<li id="menu-item-32" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-28 current_page_item menu-item-32"><a href="indexc583.html?page_id=28">Contact us</a></li>
</ul></div>			</div>
		</nav><!-- #site-navigation -->
	</header><!-- #masthead -->
...
<article id="post-28" class="post-28 page type-page status-publish hentry">
    ...
    <h3>YOUR MESSAGE WAS SENT SUCCESSFULLY, THANK YOU!!<br>
</h3>
		<div style="margin-left: 20px;">
          <p><b>Address:</b><br>
            17 Hanover Square London W1S 1BN United Kingdom<br>
            <br /> 
           <b>Email:</b> <span class="textwidget">info@elmerglobal.com</span>
           <br />
           <b>Phone: </b> </span class="textwidget"> +44 793 705 9698 </span>

       </p>
        <form id="contactform" class="contactform" method="post" action="mail.php"><p class="contact_name">
	  <input type="text" tabindex="1" size="22" value="" id="contact_name" name="name"  required/>
		<label for="contact_name">
			<small>Name (required)</small>
		</label>
	</p>
	<p class="contact_email">
		<input type="email" tabindex="2" size="22" value="" id="contact_email" name="email"  required/>
		<label for="contact_email">
			<small>Email (required)</small>
		</label>
	</p>
	<p class="contact_phone">
		<input type="text" tabindex="3" size="22" value="" id="contact_phone" name="phone"  required/>
		<label for="contact_phone">
			<small>Phone</small>
		</label>
	</p>
	<p class="contact_message">
		<textarea tabindex="4" rows="10" cols="60" id="contact_message" name="message"></textarea>
	</p>
